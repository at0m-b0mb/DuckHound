...
def keystroke_access() -> tuple[bool, str]:
    """Return (granted, human_detail) for global keyboard monitoring."""
    if sys.platform == "darwin":
        ...
        try:
            ...
            pass
        if missing:
            return False, "Grant " + " + ".join(missing) + " to your terminal / app"
        return True, "Input Monitoring + Accessibility granted"
